...
PARTITIONED BY(plat_code string)
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\001' LINES TERMINATED BY '\n'
STORED AS ORC tblproperties ("orc.compress" = "SNAPPY");

-- 只对淘宝和线下平台的数据
insert overwrite table dw_rfm.b_offline_last30day_trade_temp partition(plat_code)
...
insert overwrite table dw_rfm.b_offline_last30day_member_trade_temp partition(plat_code)
