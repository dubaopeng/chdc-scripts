...
-- 计算卡、平台、店铺的总统计指标
insert overwrite table dw_rfm.b_shop_sale_total_statics_temp
...
insert overwrite table dw_rfm.b_plat_sale_total_statics_temp
...
insert overwrite table dw_rfm.b_shop_member_total_statics_temp
...
insert overwrite table dw_rfm.b_plat_member_total_statics_temp
select card_plan_id,plat_code,date_type,
...
insert overwrite table dw_rfm.b_shop_grade_total_statics_temp
...
-- 计算店铺各个时段的会员销售综合统计数据
insert into table dw_rfm.b_shop_grade_total_statics_temp
...
insert overwrite table dw_rfm.b_plat_grade_total_statics_temp
...
drop table if exists dw_rfm.cix_offline_plat_member_sale_rate;
...
insert overwrite table dw_rfm.cix_offline_plat_member_sale_rate
...
from (
	select a.card_plan_id,a.plat_code,a.date_type,a.total_payment,a.total_times,
		   ...
		   b.grade
	from dw_rfm.b_plat_sale_total_statics_temp a
	left join dw_rfm.b_plat_grade_total_statics_temp b
...
drop table if exists dw_rfm.cix_offline_sale_shops_of_card;
...
insert overwrite table dw_rfm.cix_offline_sale_shops_of_card
...
from(
	...
	from dw_rfm.b_shop_sale_total_statics_temp a
	left join 
	(
...
left join dw_rfm.b_shop_grade_total_statics_temp c
