SET mapred.job.name='s_std_product-商品数据同步';
...
-- 创建商品历史信息表
CREATE TABLE IF NOT EXISTS dw_business.`b_std_product`(
	`data_from` int,
	`partner` string,
    `plat_code` string,
	`product_id` string,
...
-- 合并并去重插入结果表
insert overwrite table dw_business.b_std_product
select t.data_from,t.partner,t.plat_code,t.product_id,t.uni_shop_id,t.shop_id,t.category_id,t.type,t.stock, t.product_name, 
	   t.price,t.detail_url,t.pic_url,t.modified,t.online_time,t.offline_time,t.outer_product_id,t.status,t.seller_cid
 from (
	select re.*,row_number() over(distribute by re.partner,re.plat_code,re.product_id sort by re.modified desc) as num
	from (
		select t1.* from dw_business.b_std_product t1
		union all 
		select t2.data_from,t2.partner,t2.plat_code,t2.product_id,t2.uni_shop_id,t2.shop_id,t2.category_id,t2.type,t2.stock,t2.product_name, 
			   t2.price,t2.detail_url,t2.pic_url,t2.modified,t2.online_time,t2.offline_time,t2.outer_product_id,t2.status,t2.seller_cid
			from dw_source.s_std_product_increm t2 
