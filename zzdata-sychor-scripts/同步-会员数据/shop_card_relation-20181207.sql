...
select a.card_plan_id,a.plat_code,a.shop_id,a.tenant
from (
	select card_plan_id,plat_code,shop_id,tenant,
	row_number() over (partition by card_plan_id,plat_code,shop_id) as num 
