SET mapred.job.name='b_interaction_statistics_base-互动历史统计作业';
...
insert into table dw_business.`b_interaction_statistics_base` partition(part)
...
(
 ...
 from(
    select plat_code,plat_account,shop_id,interaction_time from dw_business.`b_interaction_history`
