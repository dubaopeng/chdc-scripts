SET mapred.job.name='sales-structure-analyze-销售结构分析';
...
group by t.plat_code,t.uni_shop_id,t.shop_id,t.timerange;
...
select r1.tenant,r1.plat_code,r1.uni_shop_id,r1.dmonth,
	   ...
	   0 as new_repeat_num, --新客复购人数 TODO
	   0 as new_repeat_rate --新客复购率
from 
(
	...
	(
		...
		left join dw_rfm.b_qqd_shop_rfm b
...
select r1.tenant,r1.plat_code,r1.uni_shop_id,r1.dmonth,
	   ...
	   0 as old_repeat_num, --回头客复购人数 TODO
	   0 as old_repeat_rate --回头客复购率
from 
(
	select t.tenant,t.plat_code,t.uni_shop_id,t.dmonth,
...
(
	...
	(
		...
		left join dw_rfm.b_qqd_plat_rfm b
...
-- 统计完成后需要将表 dw_rfm.cix_online_member_consume_transform 的分区${stat_date}下的数据同步给业务库
...
(
	...
	(
		...
		left join dw_rfm.b_qqd_tenant_rfm b
