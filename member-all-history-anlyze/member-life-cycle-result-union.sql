SET mapred.job.name='member-life-cycle-result-union-合并所有历史月底数据同步到业务库';
...
CREATE TABLE IF NOT EXISTS dw_rfm.`cix_online_member_life_cycle_pre13month`(
	`tenant` string,
	`plat_code` string,
    `uni_shop_id` string,
	`card_plan_id` string,
...
insert overwrite table dw_rfm.cix_online_member_life_cycle_pre13month
select t.tenant,t.plat_code,t.uni_shop_id,t.card_plan_id,t.grade,t.prospective,
...
-- 需要将cix_online_member_life_cycle_pre13month通过sqoop同步到业务库中
